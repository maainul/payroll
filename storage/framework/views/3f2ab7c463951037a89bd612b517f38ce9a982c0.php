                ...
                <table id="zero_config" class="table table-striped table-bordered">
                    ...
                    foreach($all_employee as $v_all_employee) {?>
                        <tr>
                            ...
                            <td>
                            	<a href="<?php echo e(URL::to('/manager-employee-detail/'.$v_all_employee->employee_id)); ?>"><button type="button" class="btn btn-outline-primary">Detail</button></a>
                            	<a href="<?php echo e(URL::to('/leave-form/'.$v_all_employee->employee_id)); ?>"><button type="button" class="btn btn-outline-success">Leave</button></a>
                            </td>
                        </tr>
                        <?php  
                    } ?>
