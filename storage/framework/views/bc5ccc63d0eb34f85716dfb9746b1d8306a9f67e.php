...
<div class="page-breadcrumb">
    <div class="row">
        <div class="col-12 d-flex no-block align-items-center">
            <h4 class="page-title">Add Local Client</h4>
            <div class="ml-auto text-right">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="<?php echo e(URL::to('/dashboard')); ?>">Home</a></li>
                        <li class="breadcrumb-item active" aria-current="page">local Client Form</li>
                    </ol>
                </nav>
            </div>
        </div>
...
<!-- ============================================================== -->
    ...
    <!-- ============================================================== -->
        <div class="col-md-9">
			<div class="card">
			    <form class="form-horizontal" action="<?php echo e(url('/add-local-client')); ?>" method="post">
			    	<?php echo e(csrf_field()); ?>

			        <div class="card-body">
			            <h4 class="card-title"> Local Client Information</h4>
			            ...
			            <div class="form-group row">
			                ...
			                <div class="col-sm-9">
			                    <input type="text" class="form-control" name="lclient_name" id="fname" placeholder="Client Name Here" required="">
			                </div>
			            </div>
			            <div class="form-group row">
			                <label for="lname" class="col-sm-3 text-right control-label col-form-label">Client Phone Number</label>
			                <div class="col-sm-9">
			                    <input type="text" class="form-control" name="lclient_phone" maxlength="11" minlength="11" id="lname" placeholder="Phone Number Here(11 digit) " required="">
			                </div>
			            </div>
			            <div class="form-group row">
			                <label for="email" class="col-sm-3 text-right control-label col-form-label">Client email</label>
			                <div class="col-sm-9">
			                    <input type="email" class="form-control" name="lclient_email" id="email1" placeholder="Client email Here.. example@gmail.com">
			                </div>
			            </div>
			            <div class="form-group row">
                    ...
                    <br>
                        ...
                        <div class="form-group row">
			                ...
			                <div class="col-sm-3">
			                    <input type="text" class="form-control" name="product_rate" id="rate" placeholder="Enter Rate" required="">
			                </div>
			            </div>
			            <div class="progress m-t-15">
                            <div class="progress-bar bg-info" role="progressbar" style="width: 50%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
			        ...
			        <div class="border-top">
			            <div class="card-body">
			                <button type="submit" class="btn btn-primary">Add Local Client</button>
			            </div>
			        </div>
			    </form>
			</div>
