...
<div class="page-breadcrumb">
    <div class="row">
        <div class="col-12 d-flex no-block align-items-center">
            <h4 class="page-title">ecopress data management</h4>
        ...
        <div class="col-md-6 col-lg-3">
            ...
            <div class="card card-hover">
                <div class="box bg-cyan text-center">
                    ...
                    <h6 class="text-white">Daily Total</h6>
                    <h5><?php echo e($total= $daily_total); ?> TK</h5>
                </div>
            </div>
        </div>
        <!-- Column -->
        <div class="col-md-6 col-lg-3">
            ...
            <div class="card card-hover">
                <div class="box bg-success text-center">
                    ...
                    <h6 class="text-white">Daily Advance</h6>
                    <h5><?php echo e($advance= $daily_advance); ?> TK</h5>
                </div>
            </div>
        </div>
         <!-- Column -->
        <div class="col-md-6 col-lg-3">
            <div class="card card-hover">
                <div class="box bg-warning text-center">
                    ...
                    <h6 class="text-white">Daily Due</h6>
                    <h5><?php echo e($due=$total-$advance); ?> TK</h5>
                </div>
            </div>
        </div>
        <!-- Column -->
        <div class="col-md-6 col-lg-3">
            ...
            <div class="card card-hover">
                <div class="box bg-danger text-center">
                    ...
                    <h6 class="text-white">Daily Cost</h6>
                    <h5><?php echo e($daily_cost); ?></h5>
                </div>
            </div>
        </div>
    </div>
