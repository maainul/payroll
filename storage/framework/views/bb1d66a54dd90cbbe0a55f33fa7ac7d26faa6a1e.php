                ...
                <table class="table table-striped table-bordered">
                    ...
                    foreach($attendance_employee as $v_attend_employee) {?>
                        <tr>
                            ...
                            <td><input type="time" name="att_in[<?php echo e($v_attend_employee->employee_id); ?>]" value="08:00"></td>
                            <td><input type="time" name="att_out[<?php echo e($v_attend_employee->employee_id); ?>]" value="17:00"></td>
                        </tr>
                        <?php  $i++;
                    } ?>
                    </tbody>
