...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <h5 class="card-title"> Employee List For Update Attendance <?php echo e($a_date); ?></h5>
            
            <div class="table-responsive">
                 <form action="<?php echo e(url('/manager-update-attendance')); ?>" method="post">
                ...
                <table class="table table-striped table-bordered">
                    ...
                    <?php 
                    $i=1;
                    foreach($attendance as $v_attend_detail) {?>
                        <tr>
                            <td><?php echo e($i); ?></td>
                           ...
                           <input type="hidden" name="attendance_date" value="<?php echo e($a_date); ?>">
                        </tr>
                        <?php  $i++;
                    } ?>
                    </tbody>
