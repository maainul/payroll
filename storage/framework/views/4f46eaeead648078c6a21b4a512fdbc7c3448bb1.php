...
<div class="page-breadcrumb">
    <div class="row">
        <div class="col-12 d-flex no-block align-items-center">
            <h4 class="page-title">Add Corporate Client</h4>
...
<!-- ============================================================== -->
    ...
    <!-- ============================================================== -->
        <div class="col-md-9">
			<div class="card">
			    <form class="form-horizontal" action="<?php echo e(url('/add-corporate-client')); ?>" method="post">
			        ...
			        <div class="card-body">
			            ...
			            <div class="form-group row">
			                ...
			                <div class="col-sm-9">
			                    <input type="text" class="form-control" name="company_name" id="fname" placeholder="Company Name Here" required="">
			                </div>
			            </div>
			            <div class="form-group row">
			                <label for="fname" class="col-sm-3 text-right control-label col-form-label">Company Department</label>
			                <div class="col-sm-9">
			                    <input type="text" class="form-control" name="company_department" id="fname" placeholder="Company Department Here" required="">
			                </div>
			            </div>
			            <div class="form-group row">
			            ...
			            <div class="form-group row">
			                ...
			                <div class="col-sm-9">
			                    <input type="email" class="form-control" name="company_email" id="email1" placeholder="Company email Here.. example@gmail.com">
			                </div>
			            </div>
			            <div class="form-group row">
			            ...
			            <div class="form-group row">
			                ...
			                <div class="col-sm-9">
			                    <input type="text" class="form-control" name="compliance_name" id="fname" placeholder="Compliance Name Here" required="">
			                </div>
			            </div>
			            <div class="form-group row">
			                <label for="fname" class="col-sm-3 text-right control-label col-form-label">Officer Phone </label>
			                <div class="col-sm-9">
			                    <input type="text" class="form-control" name="compliace_phone" minlength="11" maxlength="11" id="fname" placeholder="Compliance Phone Number Here" required="">
			                </div>
			            </div>
			            <div class="progress m-t-15">
                            <div class="progress-bar bg-info" role="progressbar" style="width: 50%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                        ...
                        <div class="form-group row">
			                <label for="product_name" class="col-sm-2 text-right control-label col-form-label">Product Name</label>
			                <div class="col-sm-6">
			                    <input type="text" class="form-control" name="product_name" id="product_name" placeholder="Enter Product Name">
			                </div>
			                <label for="rate" class="col-sm-1 text-right control-label col-form-label"> Rate</label>
			                <div class="col-sm-3">
			                    <input type="text" class="form-control" name="product_rate" id="rate" placeholder="Enter Rate">
			                </div>
			            </div>
			            <div class="progress m-t-15">
                            <div class="progress-bar bg-info" role="progressbar" style="width: 50%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
			        ...
			        <div class="border-top">
			            <div class="card-body">
			                <button type="submit" class="btn btn-primary">Add Corporate Client</button>
			            </div>
			        </div>
			    </form>
			</div>
