            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                <div class="navbar-header" data-logobg="skin5">
                    ...
                    <a class="navbar-brand" href="{{URL::to('/dashboard')}}">
                        ...
                        <b class="logo-icon p-l-10">
                            ...
                            <!-- Dark Logo icon -->
                            <img src="{{URL::to('backend/assets/images/logo-icon.jpg')}}" alt="homepage" class="light-logo" />
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin5">
                    ...
                    <ul class="navbar-nav float-left mr-auto">
                        ...
                        <!-- ============================================================== -->
                         <li class="nav-item">
                            <a class="nav-link" href="{{URL::to('/add-login-form')}}"  role="button"  aria-haspopup="true" aria-expanded="false"><span class="d-none d-md-block">Role Employee</span></a>
                        </li>
                         <li class="nav-item">
                            <a class="nav-link" href="{{URL::to('/all-roller')}}"  role="button"  aria-haspopup="true" aria-expanded="false"><span class="d-none d-md-block">Role List</span></a>
                        </li>
                    </ul>
                    <!-- ============================================================== -->
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated">
                                <a class="dropdown-item" href="{{url('/account-setting')}}"><i class="ti-settings m-r-5 m-l-5"></i> Account Setting</a>
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="p-t-30">
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{URL::to('/dashboard')}}" aria-expanded="false"><i class="mdi mdi-view-dashboard"></i><span class="hide-menu">Admin</span></a></li>
                    </ul>
                </nav>
