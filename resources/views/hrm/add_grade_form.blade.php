...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <form class="form-horizontal" action="{{URL::to('/add-grade')}}" method="post">
                {{csrf_field()}}
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Festible Bonus</label>
                        <div class="col-sm-9">
                            <input type="text" name="festible_bonus" class="form-control" id="fname" placeholder="Enter Festible Bonus Here" required="">
                        </div>
                    </div>
                    <div class="form-group row">
