...
<div class="row">
    <div class="col-md-6">
        <div class="card">
            <form class="form-horizontal" action="{{URL::to('/add-office')}}" method="post">
                {{csrf_field()}}
                <div class="card-body">
    ...
    <div class="col-md-6">
    <div class="card">
        <form class="form-horizontal" action="{{URL::to('/add-unit')}}" method="post">
            {{csrf_field()}}
            <div class="card-body">
            ...
            <div class="table-responsive">
                <table id="zero_config" class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{$i}}</td>
                            <td>{{$adv=$v_show_unit->office_name}}</td>
                            <td>{{$adv=$v_show_unit->unit_name}}</td>
                            <td>
                                <a href="{{URL::to('show-update-office/'.$v_show_unit->unit_id)}}"><button type="button" class="btn btn-outline-primary">Update</button></a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
               <a href="{{url('/delete-unit/'.$v_show_unit->unit_id)}}"> <button type="button" class="btn btn-danger waves-effect waves-light save-category">Delete</button></a>
