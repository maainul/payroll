...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <form class="form-horizontal" action="{{URL::to('/add-employee')}}" method="post" enctype="multipart/form-data">
                {{csrf_field()}}
                <div class="card-body">
                    ...
                    <div class="col-sm-9">
                        <select name="designation_id" class="select2 form-control custom-select" style="width: 100%; height:36px;"> required="">
                            ...
                            <option value="{{$v_all_designation->designation_id}}">{{$v_all_designation->department_name}}-{{$v_all_designation->designation_name}}</option>
                          @endforeach
                        </select>
                    </div>
                    </div>
                    ...
                    <div class="col-sm-9">
                        <select name="grade_id" class="select2 form-control custom-select" style="width: 100%; height:36px;"> required="">
                            ...
                            <option value="{{$v_all_grade->grade_id}}">{{$v_all_grade->grade_name}}</option>
                          @endforeach
                        </select>
                    </div>
                    </div>
