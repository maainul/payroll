            ...
            <div class="table-responsive">
                <table id="zero_config" class="table table-striped table-bordered">
                    ...
                    foreach($all_grade as $v_all_grade) {?>
                        <tr>
							<td>{{$v_all_grade->grade_name}}</td>
                            <td>{{$v_all_grade->total_salary}}</td>
                            <td>{{$v_all_grade->basic_salary}}</td>
                            <td>{{$v_all_grade->home_rent}}</td>
                            <td>{{$v_all_grade->medical_allowance}}</td>
                            <td>{{$v_all_grade->transport_allowance}}</td>
                            <td>{{$v_all_grade->lunch_allowance}}</td>
                            <td>{{$v_all_grade->ot_rate}}</td>
                            <td>
