...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <form class="form-horizontal" action="{{URL::to('/add-roller')}}" method="post">
                {{csrf_field()}}
                <div class="card-body">
            ...
            <div class="table-responsive">
                <table id="zero_config" class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{$i}}</td>
                            <td>{{$v_role->admin_name}}</td>
                            <td>{{$v_role->admin_phone}}</td>
                            <td>{{$v_role->admin_type}}</td>
                            <td>
                                <a href="{{URL::to('/show-update-roller/'.$v_role->admin_id)}}"><button type="button" class="btn btn-outline-primary">Update</button></a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
               <a href="{{url('/delete-roller/'.$v_role->admin_id)}}"> <button type="button" class="btn btn-danger waves-effect waves-light save-category">Delete</button></a>
