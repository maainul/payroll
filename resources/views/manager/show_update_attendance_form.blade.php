...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <h5 class="card-title"> Employee List For Update Attendance {{$a_date}}</h5>
            
            <div class="table-responsive">
                 <form action="{{url('/manager-update-attendance')}}" method="post">
                    {{csrf_field()}}
                <table class="table table-striped table-bordered">
                    ...
                    foreach($attendance as $v_attend_detail) {?>
                        <tr>
                           ...
                           <input type="hidden" name="attendance_date" value="{{$a_date}}">
                        </tr>
                        <?php  $i++;
                    } ?>
                    </tbody>
