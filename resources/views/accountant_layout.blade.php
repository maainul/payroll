        ...
        <header class="topbar" data-navbarbg="skin5">
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                <div class="navbar-header" data-logobg="skin5">
                    ...
                    <!-- Logo -->
                    <!-- ============================================================== -->
                    <a class="navbar-brand" href="{{URL::to('/accountant')}}">
                        <!-- Logo icon -->
                    ...
                    <ul class="navbar-nav float-left mr-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="{{URL::to('/current-unit')}}">Unit Wise Salary</a>
                            </div>
                        </li>
                         <li class="nav-item">
                            <a class="nav-link" href="{{URL::to('/generate-salary-form')}}"  role="button"  aria-haspopup="true" aria-expanded="false"><span class="d-none d-md-block">Salary Record</span></a>
                        </li>
                    </ul>
                    <!-- ============================================================== -->
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="p-t-30">
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{URL::to('/accountant')}}" aria-expanded="false"><i class="mdi mdi-view-dashboard"></i><span class="hide-menu">Accountant</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{URL::to('/employee-list')}}" aria-expanded="false"><i class="mdi mdi-view-dashboard"></i><span class="hide-menu">Employee</span></a></li>
                    </ul>
                </nav>
