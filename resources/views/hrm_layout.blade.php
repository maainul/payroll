        ...
        <header class="topbar" data-navbarbg="skin5">
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                <div class="navbar-header" data-logobg="skin5">
                    ...
                    <!-- Logo -->
                    <!-- ============================================================== -->
                    <a class="navbar-brand" href="{{URL::to('/hr-manager')}}">
                        <!-- Logo icon -->
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="p-t-30">
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{URL::to('/hr-manager')}}" aria-expanded="false"><i class="mdi mdi-view-dashboard"></i><span class="hide-menu">HR Manager</span></a></li>
                       <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{URL::to('/add-office-form')}}" aria-expanded="false"><i class="mdi mdi-chart-bubble"></i><span class="hide-menu">Office-Unit & Dept</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-account-box"></i><span class="hide-menu">Dept. & Designation </span></a>
                            <ul aria-expanded="false" class="collapse  first-level">
                                <li class="sidebar-item"><a href="{{URL::to('/designation-form')}}" class="sidebar-link"><i class="mdi mdi-account-plus"></i><span class="hide-menu"> Add Depat. & Designation </span></a></li>
                                <li class="sidebar-item"><a href="{{URL::to('/designation-list')}}" class="sidebar-link"><i class="mdi mdi-account-multiple"></i><span class="hide-menu"> Designation List </span></a></li>
                            </ul>
                        </li>
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-cash-usd"></i><span class="hide-menu">Grade Option</span></a>
                            <ul aria-expanded="false" class="collapse  first-level">
                                <li class="sidebar-item"><a href="{{URL::to('/grade-form')}}" class="sidebar-link"><i class="mdi mdi-credit-card-plus"></i><span class="hide-menu"> Add Grade </span></a></li>
                                <li class="sidebar-item"><a href="{{URL::to('/grade-list')}}" class="sidebar-link"><i class="mdi mdi-credit-card"></i><span class="hide-menu">Grade List List </span></a></li>
                            </ul>
                        </li>
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-rocket"></i><span class="hide-menu">Employee</span></a>
                            <ul aria-expanded="false" class="collapse  first-level">
                                <li class="sidebar-item"><a href="{{URL::to('/add-employee-form')}}" class="sidebar-link"><i class="mdi mdi-telegram"></i><span class="hide-menu"> Add Employee </span></a></li>
                                <li class="sidebar-item"><a href="{{URL::to('/employee-list-for-hrm')}}" class="sidebar-link"><i class="mdi  mdi-view-agenda"></i><span class="hide-menu"> Employee List </span></a></li>
                            </ul>
                        </li>
                         <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{URL::to('/festible-form')}}" aria-expanded="false"><i class="mdi mdi-chart-bubble"></i><span class="hide-menu">Festible</span></a></li>
                    </ul>
                </nav>
