                ...
                <table id="zero_config" class="table table-striped table-bordered">
                    ...
                    foreach($all_employee as $v_all_employee) {?>
                        <tr>
                            ...
                            <td>
                            	<a href="{{URL::to('/employee-detail/'.$v_all_employee->employee_id)}}"><button type="button" class="btn btn-outline-primary">Detail</button></a>
                            	<a href="{{URL::to('/emplolyee-salary/'.$v_all_employee->employee_id)}}"><button type="button" class="btn btn-outline-success">Salary</button></a>
                            </td>
                        </tr>
                        <?php  
                    } ?>
